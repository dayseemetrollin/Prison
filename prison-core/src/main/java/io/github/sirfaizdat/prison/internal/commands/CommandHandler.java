...
import io.github.sirfaizdat.prison.internal.commands.handlers.*;
...
public class CommandHandler {
    ...
    public boolean onCommand(CommandSender sender, PluginCommand command, String label, String[] args) {
        ...
        if (rootCommand.onlyPlayers() && sender.getType() != CommandSender.Type.PLAYER) {
